public class Romes extends Number {
    ...
    Romes(String value1, String value2) throws NoValidateTipExeption {
        boolean onlyFrom0to10=true;
        ...
        if (onlyFrom0to10 && (romes_value1_int < 0 || !(romes_value1_int < 10))) throw new NoValidateTipExeption("Только от 0 до 10ти или присвойте onlyFrom0to10=false");
        else{
            if (onlyFrom0to10 && (romes_value2_int < 0 || romes_value2_int >10)) throw new NoValidateTipExeption("Только от 0 до 10ти или присвойте onlyFrom0to10=false");
        }
    }
