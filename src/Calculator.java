...
public class Calculator {
    ...
    public static void main(String[] args) throws NoValidateTipExeption {
        ...
        while (!input.isEmpty()) {
            ...
            try {
                ...
                if (onlyFrom0to10 && (value1 < 0 || value1 >10)) throw new NoValidateTipExeption("Только от 0 до 10ти или присвойте onlyFrom0to10=false");
                else{
                    if (onlyFrom0to10 && (value2 < 0 || value2 >10)) throw new NoValidateTipExeption("Только от 0 до 10ти или присвойте onlyFrom0to10=false");
                }
